...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            hero_subtitle: "La barrera del idioma y la mala preparación del paciente no son solo un problema de atención, son un agujero negro para la rentabilidad de tu clínica.",
            ...
            problem_desc: "¿Has calculado el costo real de una mala comunicación médica?",
            ...
            problem_2_title: "Pérdidas de 200€ a 400€ por hueco de pruebas",
            problem_2_desc: "Un paciente extranjero que desayunó sólido porque no entendió el PDF en español = box de pruebas, gastroenterólogo y anestesista parados.",
            ...
            sol_feat_3_title: "Asistente IA Integrado",
            sol_feat_3_desc: "Responde al instante dudas como '¿Puedo beber agua ahora?', basándose 100% en los protocolos estrictos de la clínica.",
            chat_badge: "✨ +16 Idiomas Soportados",
            ...
            p2_desc: "La solución completa para clínicas y medianos centros.",
            ...
            p2_f3: "<strong>Filtro de Pruebas Activas:</strong> Oculte pruebas del catálogo global que no realiza su centro.",
            ...
            p2_f8: "<strong>Asistente Inteligente (IA):</strong> Chatbot multilingüe con límites estrictos de responsabilidad médica.",
            ...
            p3_f2: "<strong>Licencia Nodo Central:</strong> Uso ilimitado para Centro Principal y Centros Periféricos asociados.",
            p3_f3: "<strong>Servicio White-Glove:</strong> Configuración y mantenimiento total por nuestro equipo.",
            p3_f4: "<strong>Dominio Personalizado:</strong> Mapeo transparente bajo su propio dominio (ej. preparacion.hospitalx.es).",
            faq_title: "¿Dudas? Resolvemos sus preocupaciones",
            faq_1_q: "\"Ya les damos un folio impreso en inglés al paciente.\"",
            faq_1_a: "El papel se pierde, no es interactivo y no resuelve dudas a las 9 de la noche cuando la clínica cierra. El paciente acaba buscando en Google y confundiendo protocolos de otras clínicas. Con nuestra App, resuelven sus dudas con <strong>su protocolo exacto</strong>.",
            faq_2_q: "\"¿Qué pasa si la IA le dice a un paciente que deje su medicación para el corazón?\"",
            faq_2_a: "Nuestra IA está bloqueada con instrucciones estrictas de responsabilidad (<em>Guardrails</em>). Está entrenada EXCLUSIVAMENTE para temas de ayuno y preparación. Si detecta palabras como 'medicación', 'Sintrom' o síntomas, responde automáticamente: <em>\"Por favor, consulte cualquier ajuste de medicación directamente con su médico especialista.\"</em>",
            faq_3_q: "\"No tenemos tiempo informático para configurar esto.\"",
            faq_3_a: "Ofrecemos la modalidad de <strong>Servicio Gestionado (White-Glove)</strong>. Nos envían el PDF o manual que usan hoy, y nuestro equipo deja la plataforma lista, con su logotipo y su URL personalizada. Ustedes solo tienen que poner el código QR en el mostrador mañana mismo.",
            cta_title: "Elimine la fricción con pacientes extranjeros",
            cta_desc: "Téngalo listo mañana en su mostrador de recepción mediante nuestro servicio White-Glove.",
        ...
        en: {
            ...
            hero_subtitle: "Language barriers and poor patient preparation aren't just a care issue; they are a black hole for your clinic's profitability.",
            hero_cta_solution: "Discover ComoMePreparo",
            hero_cta_roi: "View ROI",
            problem_title: "The Money and Time Black Hole",
            problem_desc: "Have you calculated the real cost of poor medical communication?",
            ...
            problem_2_title: "Losses of €200 to €400 per procedure slot",
            problem_2_desc: "An international patient who ate solid food because they didn't understand the Spanish PDF = idle procedure room, gastroenterologist, and anesthesiologist.",
            ...
            sol_feat_3_title: "Integrated AI Assistant",
            sol_feat_3_desc: "Responds instantly to questions like 'Can I drink water now?', based 100% on the clinic's strict protocols.",
            chat_badge: "✨ +16 Languages Supported",
            ...
            p2_f3: "<strong>Active Test Filter:</strong> Hide tests from the global catalog that your center doesn't perform.",
            ...
            p2_f8: "<strong>Smart Assistant (AI):</strong> Multilingual chatbot with strict medical liability limits.",
            ...
            p3_f2: "<strong>Central Node License:</strong> Unlimited use for Main Center and associated Peripheral Centers.",
            p3_f3: "<strong>White-Glove Service:</strong> Full configuration and maintenance by our team.",
            p3_f4: "<strong>Custom Domain:</strong> Seamless mapping under your own domain (e.g. preparation.hospitalx.com).",
            faq_title: "Questions? We solve your concerns",
            faq_1_q: "\"We already give patients a printed sheet in English.\"",
            faq_1_a: "Paper gets lost, is not interactive, and doesn't solve doubts at 9 PM when the clinic is closed. Patients end up searching Google and confusing protocols. With our App, they solve doubts with **your exact protocol**.",
            faq_2_q: "\"What if the AI tells a patient to stop their heart medication?\"",
            faq_2_a: "Our AI is locked with strict liability instructions (<em>Guardrails</em>). It is trained EXCLUSIVELY for fasting and preparation topics. If it detects words like 'medicación', 'blood thinners' or symptoms, it automatically responds: <em>\"Please check any medication adjustments directly with your specialist doctor.\"</em>",
            faq_3_q: "\"We don't have IT time to set this up.\"",
            faq_3_a: "We offer the **White-Glove Managed Service**. You send us the PDF or manual you use today, and our team gets the platform ready with your logo and URL. You just put the QR code on the counter tomorrow.",
            cta_title: "Eliminate friction with international patients",
            cta_desc: "Have it ready tomorrow at your reception desk with our White-Glove service.",
