...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            hero_title: "Instrucciones médicas que dan tranquilidad, no ansiedad",
            hero_subtitle: "Elimine la confusión del paciente con guías interactivas y paso a paso. Una mejor preparación significa mejores resultados y menos estrés para todos.",
            hero_cta_solution: "Descubra ComoMePreparo",
            hero_cta_roi: "Ver soluciones",
            problem_title: "La brecha de comunicación en la preparación médica",
            problem_desc: "¿Sabía que la principal causa de una mala preparación es la confusión del paciente con las instrucciones en papel?",
            ...
            problem_2_title: "Pérdidas por hueco de pruebas",
            ...
            solution_lead: "Una plataforma humana que guía al paciente en su propio idioma, para que llegue a su prueba con mayor confianza y seguridad.",
            ...
            sol_feat_2_desc: "Saben qué hacer 24h antes, 12h antes y el día de la prueba, favoreciendo la máxima adherencia al protocolo.",
            ...
            pricing_bubble: "Configuraciones adaptadas",
            pricing_title: "Soluciones para cada fase de su clínica",
            pricing_desc: "Maximice la ocupación de sus salas, evite reprogramaciones y reduzca los tiempos de espera de sus pacientes.",
            ...
            p3_f3: "<strong>Estandarización de protocolos:</strong> Control central para que todas las sedes utilicen las mismas instrucciones y estándares de calidad aprobados por el grupo.",
            ...
            roi_title: "📊 Optimización de la atención y reducción de esperas",
            roi_col_test: "Prueba médica",
            roi_col_impact: "⚠️ Impacto económico de cada reprogramación",
            roi_r1_test: "Ecografía",
            roi_r2_test: "TC",
            roi_r3_test: "Resonancia magnética",
            roi_r4_test: "Endoscopias (gastroscopia o colonoscopia)",
            ...
            faq_3_q: "No tenemos equipo técnico para configurar esto.",
            ...
            faq_5_a: "Sí. Utilizamos modelos de inteligencia artificial en modo Enterprise con infraestructura dentro de la Unión Europea. Los datos no se utilizan para entrenar modelos.",
            ...
            faq_9_a: "Es una herramienta de soporte informativo y recordatorio. No realiza diagnósticos ni toma decisiones clínicas, por lo que actúa legalmente como una aplicación informativa.",
            ...
            success_desc: "Hemos recibido sus datos y nos pondremos en contacto con su clínica en las próximas 24 horas.",
            benefits_bubble: "Propuesta de valor",
            benefits_title: "¿Por qué elegir ComoMePreparo™?",
            ...
            ben_1_a: "<strong>Reducción de cancelaciones y repeticiones:</strong> Facilite que el paciente llegue preparado a la primera, evitando huecos vacíos en agendas críticas (RM, TAC) y el sobrecoste de repetir pruebas.",
            ...
            ben_2_title: "Tranquilidad y confianza del paciente",
        ...
        en: {
            ...
            hero_title: "Medical instructions that reassure, not overwhelm",
            hero_subtitle: "Eliminate patient confusion with interactive, step-by-step guides. Better preparation means better results and less stress for everyone.",
            hero_cta_solution: "Discover ComoMePreparo",
            hero_cta_roi: "View solutions",
            problem_title: "The communication gap in medical preparation",
            problem_desc: "Did you know the leading cause of poor preparation is patient confusion with paper instructions?",
            problem_1_title: "Time lost at reception",
            problem_1_desc: "How much time does your staff spend daily on the phone explaining colonoscopy prep to a British or German patient?",
            problem_2_title: "Losses per procedure slot",
            problem_2_desc: "A local patient who missed their diet because the PDF was technical and confusing, or an international patient who didn't understand the language = an empty procedure room.",
            solution_bubble: "Your solution",
            solution_title: "Introducing \"ComoMePreparo\"",
            solution_lead: "A human-centric platform that guides patients in their own language, so they arrive at their test with greater confidence and safety.",
            sol_feat_1_title: "Goodbye to 15-minute phone calls",
            sol_feat_1_desc: "The patient receives a QR or SMS. They select their test and read the exact instructions from YOUR clinic on their phone, in their native language.",
            sol_feat_2_title: "Step-by-step timeline",
            sol_feat_2_desc: "They know exactly what to do 24h before, 12h before, and on the day of the test, promoting maximum compliance with the protocol.",
            ...
            pricing_bubble: "Tailored configurations",
            pricing_title: "Solutions for every stage of your clinic",
            pricing_desc: "Maximize room utilization, reduce no-shows, and shorten patient wait times.",
            ...
            p1_f2: "<strong>Standard branding:</strong> Profile with ComoMePreparo standard colors and logo.",
            ...
            p2_f2: "<strong>Custom clinic page:</strong> Exclusive profile with your URL, logo, and corporate colors.",
            ...
            p2_f8: "<strong>Smart AI assistant:</strong> 24/7 question resolution with preventive safety filters.",
            ...
            p3_f3: "<strong>Standardization of protocols:</strong> Central control so all locations use the same instructions and quality standards approved by the group.",
            ...
            roi_title: "📊 Optimized care and reduced waiting times",
            roi_col_test: "Medical test",
            roi_col_impact: "⚠️ Economic impact of each rescheduling",
            roi_r1_test: "Ultrasound",
            roi_r2_test: "CT",
            roi_r3_test: "MRI",
            roi_r4_test: "Endoscopies (gastroscopy or colonoscopy)",
            faq_title: "Questions? We've got answers",
            faq_1_q: "We already give patients a paper sheet, why would they want to use a web app?",
            faq_1_a: "Because paper doesn't allow them to add calendar reminders for fasting, isn't interactive, gets lost, and doesn't answer questions in 15 languages at 11 PM when the clinic is closed. With our platform, they get a dynamic schedule and your center's exact protocol.",
            ...
            faq_3_q: "We don't have the IT bandwidth to set this up.",
            ...
            faq_5_a: "Yes. We use enterprise-grade artificial intelligence models with infrastructure within the European Union. Data is protected and not used to train models.",
            faq_6_q: "Do I have to register each patient on a platform?",
            ...
            faq_8_a: "The platform allows generating a printable PDF with the automatically calculated schedule, so the patient can take it on paper if preferred.",
            faq_9_q: "Is this a certified medical product?",
            faq_9_a: "It is an information and reminder support tool. It does not perform diagnoses or clinical decisions, so it legally functions as an informational application.",
            ...
            benefits_title: "Why choose ComoMePreparo™?",
            ...
            ben_1_a: "<strong>Reduced cancellations and repetitions:</strong> Help patients arrive prepared the first time, avoiding empty slots in critical schedules (MRI, CT) and the extra cost of repeating tests.",
            ...
            ben_2_title: "Patient peace of mind and confidence",
            ...
            ben_2_c: "<strong>Modern interface:</strong> Projects an innovative, modern image of your clinic to patients.",
            ben_3_title: "Clinical quality and safety",
            ben_3_a: "<strong>Better image quality and results:</strong> Optimal preparation helps test results be of maximum quality, avoiding unnecessary repetitions.",
